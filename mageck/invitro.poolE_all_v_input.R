pdf(file='invitro.poolE_all_v_input.pdf',width=4.5,height=4.5);
...
dev.off()
Sweave("invitro.poolE_all_v_input_summary.Rnw");
library(tools);

texi2dvi("invitro.poolE_all_v_input_summary.tex",pdf=TRUE);
