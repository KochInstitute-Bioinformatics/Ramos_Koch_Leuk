pdf(file='invitro.poolA_hEGFRv3.CAR_ET.1.10_v_input.pdf',width=4.5,height=4.5);
...
dev.off()
Sweave("invitro.poolA_hEGFRv3.CAR_ET.1.10_v_input_summary.Rnw");
library(tools);

texi2dvi("invitro.poolA_hEGFRv3.CAR_ET.1.10_v_input_summary.tex",pdf=TRUE);
