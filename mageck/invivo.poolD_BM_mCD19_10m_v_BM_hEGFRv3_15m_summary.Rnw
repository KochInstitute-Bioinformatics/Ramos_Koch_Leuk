...
library(xtable)
comparisons=c("6,7,8,9_vs_1,2,3,4,5 neg.","6,7,8,9_vs_1,2,3,4,5 pos.");
ngenes=c(3658,3658);
...
\newpage\section{Comparison results of 6,7,8,9 vs 1,2,3,4,5 neg.}

The following figure shows the distribution of RRA score in the comparison 6,7,8,9 vs 1,2,3,4,5 neg., and the RRA scores of 10 genes.
...
\newpage\section{Comparison results of 6,7,8,9 vs 1,2,3,4,5 pos.}

The following figure shows the distribution of RRA score in the comparison 6,7,8,9 vs 1,2,3,4,5 pos., and the RRA scores of 10 genes.
