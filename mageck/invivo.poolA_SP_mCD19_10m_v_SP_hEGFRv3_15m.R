pdf(file='invivo.poolA_SP_mCD19_10m_v_SP_hEGFRv3_15m.pdf',width=4.5,height=4.5);
...
dev.off()
Sweave("invivo.poolA_SP_mCD19_10m_v_SP_hEGFRv3_15m_summary.Rnw");
library(tools);

texi2dvi("invivo.poolA_SP_mCD19_10m_v_SP_hEGFRv3_15m_summary.tex",pdf=TRUE);
