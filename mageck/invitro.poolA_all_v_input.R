pdf(file='invitro.poolA_all_v_input.pdf',width=4.5,height=4.5);
...
dev.off()
Sweave("invitro.poolA_all_v_input_summary.Rnw");
library(tools);

texi2dvi("invitro.poolA_all_v_input_summary.tex",pdf=TRUE);
