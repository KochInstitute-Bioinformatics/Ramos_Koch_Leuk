...
library(xtable)
comparisons=c("7,8,9,10,11_vs_1,2,3,4,5,6 neg.","7,8,9,10,11_vs_1,2,3,4,5,6 pos.");
ngenes=c(3932,3932);
...
\newpage\section{Comparison results of 7,8,9,10,11 vs 1,2,3,4,5,6 neg.}

The following figure shows the distribution of RRA score in the comparison 7,8,9,10,11 vs 1,2,3,4,5,6 neg., and the RRA scores of 10 genes.
...
\newpage\section{Comparison results of 7,8,9,10,11 vs 1,2,3,4,5,6 pos.}

The following figure shows the distribution of RRA score in the comparison 7,8,9,10,11 vs 1,2,3,4,5,6 pos., and the RRA scores of 10 genes.
