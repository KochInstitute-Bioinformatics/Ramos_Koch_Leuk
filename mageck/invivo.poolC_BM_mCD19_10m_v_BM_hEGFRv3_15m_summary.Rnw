...
library(xtable)
comparisons=c("5,6,7,8_vs_1,2,3,4 neg.","5,6,7,8_vs_1,2,3,4 pos.");
ngenes=c(3989,3989);
...
\newpage\section{Comparison results of 5,6,7,8 vs 1,2,3,4 neg.}

The following figure shows the distribution of RRA score in the comparison 5,6,7,8 vs 1,2,3,4 neg., and the RRA scores of 10 genes.
...
\newpage\section{Comparison results of 5,6,7,8 vs 1,2,3,4 pos.}

The following figure shows the distribution of RRA score in the comparison 5,6,7,8 vs 1,2,3,4 pos., and the RRA scores of 10 genes.
