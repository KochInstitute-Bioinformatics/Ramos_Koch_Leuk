...
library(xtable)
comparisons=c("9,10,11,12,13_vs_1,2,3,4,5 neg.","9,10,11,12,13_vs_1,2,3,4,5 pos.");
ngenes=c(3989,3989);
...
\newpage\section{Comparison results of 9,10,11,12,13 vs 1,2,3,4,5 neg.}

The following figure shows the distribution of RRA score in the comparison 9,10,11,12,13 vs 1,2,3,4,5 neg., and the RRA scores of 10 genes.
...
\newpage\section{Comparison results of 9,10,11,12,13 vs 1,2,3,4,5 pos.}

The following figure shows the distribution of RRA score in the comparison 9,10,11,12,13 vs 1,2,3,4,5 pos., and the RRA scores of 10 genes.
