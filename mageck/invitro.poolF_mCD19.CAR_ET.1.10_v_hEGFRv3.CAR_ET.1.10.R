pdf(file='invitro.poolF_mCD19.CAR_ET.1.10_v_hEGFRv3.CAR_ET.1.10.pdf',width=4.5,height=4.5);
...
dev.off()
Sweave("invitro.poolF_mCD19.CAR_ET.1.10_v_hEGFRv3.CAR_ET.1.10_summary.Rnw");
library(tools);

texi2dvi("invitro.poolF_mCD19.CAR_ET.1.10_v_hEGFRv3.CAR_ET.1.10_summary.tex",pdf=TRUE);
