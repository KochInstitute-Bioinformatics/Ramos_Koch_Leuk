...
library(xtable)
comparisons=c("amCD19_1to10rep1,amCD19_1to10rep2,amCD19_1to10rep3_vs_Input2_ACT_rep1,Input2_ACT_rep2,Input2_ACT_rep3 neg.","amCD19_1to10rep1,amCD19_1to10rep2,amCD19_1to10rep3_vs_Input2_ACT_rep1,Input2_ACT_rep2,Input2_ACT_rep3 pos.");
ngenes=c(1021,1021);
...
\newpage\section{Comparison results of amCD19 1to10rep1,amCD19 1to10rep2,amCD19 1to10rep3 vs Input2 ACT rep1,Input2 ACT rep2,Input2 ACT rep3 neg.}

The following figure shows the distribution of RRA score in the comparison amCD19 1to10rep1,amCD19 1to10rep2,amCD19 1to10rep3 vs Input2 ACT rep1,Input2 ACT rep2,Input2 ACT rep3 neg., and the RRA scores of 10 genes.
...
\newpage\section{Comparison results of amCD19 1to10rep1,amCD19 1to10rep2,amCD19 1to10rep3 vs Input2 ACT rep1,Input2 ACT rep2,Input2 ACT rep3 pos.}

The following figure shows the distribution of RRA score in the comparison amCD19 1to10rep1,amCD19 1to10rep2,amCD19 1to10rep3 vs Input2 ACT rep1,Input2 ACT rep2,Input2 ACT rep3 pos., and the RRA scores of 10 genes.
