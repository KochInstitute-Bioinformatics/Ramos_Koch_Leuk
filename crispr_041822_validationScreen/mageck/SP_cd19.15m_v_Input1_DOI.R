pdf(file='SP_cd19.15m_v_Input1_DOI.pdf',width=4.5,height=4.5);
...
dev.off()
Sweave("SP_cd19.15m_v_Input1_DOI_summary.Rnw");
library(tools);

texi2dvi("SP_cd19.15m_v_Input1_DOI_summary.tex",pdf=TRUE);
