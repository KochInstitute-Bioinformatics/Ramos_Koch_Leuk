pdf(file='cd19_1to10_v_egfr_1to10.pdf',width=4.5,height=4.5);
...
dev.off()
Sweave("cd19_1to10_v_egfr_1to10_summary.Rnw");
library(tools);

texi2dvi("cd19_1to10_v_egfr_1to10_summary.tex",pdf=TRUE);
